...
const ForgotPasswordScreen = () => {
  ...
  const handleSubmitEmail = async () => {
    ...
    try {
      const response = await authService.apiCall('/auth/customer/forgot-password', {
        method: 'POST',
  ...
  const handleVerifyCode = async () => {
    ...
    try {
      ...
      const response = await authService.apiCall('/auth/customer/verify-reset-code', {
        method: 'POST',
        body: JSON.stringify({ 
  ...
  const handleSetNewPassword = async () => {
    ...
    try {
      ...
      const response = await authService.apiCall('/auth/customer/reset-password', {
        method: 'POST',
